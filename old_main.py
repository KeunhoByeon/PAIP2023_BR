...
def process_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', metavar='TYPE', help='dataset type')
    parser.add_argument('--data-path', type=str, default='./data/train', metavar='TYPE', help='dataset type')
    ...
    parser.add_argument('--patience', type=int, default=None, metavar='M', help='Early stopping patience or None')
    parser.add_argument('--reg', nargs='+', type=float, default=[1e-6], metavar='FACTOR', help='Weight decay value')

    parser.add_argument('--no-cuda', action='store_true', default=False, help='disables CUDA training')
    parser.add_argument('--seed', type=int, default=1, metavar='S', help='random seed (default: 1)')
    parser.add_argument('--log-interval', type=int, default=10, metavar='N', help='how many batches to wait before logging training status')
    parser.add_argument('--duplicate-train', action='store_true', default=False, help='adds 90 rotations to training set')
